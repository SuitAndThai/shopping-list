...
public class DBConstants {
    ...
    public static String[] DDL = {
            "CREATE TABLE Items(_id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, status INTEGER, order INTEGER, _shopping_list_id INTEGER NOT NULL);",
            "CREATE TABLE ShoppingLists(_id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT, is_favorite INTEGER, order INTEGER);",
